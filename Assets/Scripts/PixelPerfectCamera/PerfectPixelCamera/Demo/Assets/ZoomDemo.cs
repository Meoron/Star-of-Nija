...
void Update ()
    ...
    switch (this.mode)
        ...
        case ZoomDemoMode.Marching:
            ...
            if (mainCameraIsFixed)
                {
                this.BodyText.text = "With the PerfectPixelCamera enabled, the camera's projection matrix is automatically _offset by less than a pixel and marching is fixed.";
                }
            else
                {
